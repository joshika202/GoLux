...
//A button that links to adminvehicle.php for navigation to the home page./ 
 <div class="main">
        
        <div class="register">
        <h2>Enter Details Of New Car</h2>
        <form id="register"  action="upload.php" method="POST" enctype="multipart/form-data">    
        A form (<form>) with the ID register, which submits data to upload.php using the POST method and supports file uploads with enctype="multipart/form-data".
...
<!-- This HTML document provides a form interface for administrators to input details of a new car, including the car name, fuel type, capacity, price, and an image.
 It also includes styling and a navigation button to return to the home page. -->